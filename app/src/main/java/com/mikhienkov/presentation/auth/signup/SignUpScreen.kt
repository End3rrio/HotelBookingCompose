package com.mikhienkov.presentation.auth.signup
...
import com.mikhienkov.presentation.designsystem.components.AuthenticationHeading
...
import com.mikhienkov.presentation.designsystem.components.EmailInputField
...
import com.mikhienkov.presentation.auth.GoogleAuthUiClient
    ...
    Column(
        ...
        Row(
            ...
            Text(
                ...
                color = if (BookingTheme.theme.isDark) BookingTheme.colors.greyscale100 else BookingTheme.colors.greyscale500
            )
...
private fun AccountExistDialog(
    ...
    if (open) {
        Dialog(
            ...
            shape = BookingTheme.shapes.large
        ) {
            Column(

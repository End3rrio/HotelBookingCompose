...
import com.mikhienkov.presentation.designsystem.clickableWithoutIndication
...
object InputFieldDefaults {
    ...
    val shape
        @Composable get() = BookingTheme.shapes.small
    ...
    @Composable
    fun placeholderColor() = BookingTheme.colors.greyscale500

    @Composable
    fun focusedBorderColor() = BookingTheme.colors.primary500
    ...
    fun unfocusedContainerColor() =
        if (BookingTheme.theme.isDark) BookingTheme.colors.dark2 else BookingTheme.colors.greyscale50


    @Composable
    fun unfocusedIconColor(customColor: Color, isPlaceholder: Boolean) = customColor.takeOrElse {
        return if (BookingTheme.theme.isDark) {
            if (isPlaceholder) BookingTheme.colors.greyscale500 else BookingTheme.colors.white
        } else {
            if (isPlaceholder) BookingTheme.colors.greyscale500 else BookingTheme.colors.greyscale900
        }
    }

    @Composable
    fun focusedIconColor() = BookingTheme.colors.primary500

    @Composable
    fun cursorColor() = BookingTheme.colors.primary500

    @Composable
    fun selectionColors() = TextSelectionColors(
        handleColor = BookingTheme.colors.primary500,
        backgroundColor = BookingTheme.colors.primary300
    )

    @Composable
    fun errorColor() = BookingTheme.colors.error
}
...
fun InputField(
    ...
    textStyle: TextStyle = BookingTheme.typography.bodyMediumSemiBold,

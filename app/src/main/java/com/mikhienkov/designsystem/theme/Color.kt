package com.mikhienkov.designsystem.theme
...
@Stable
data class BookingColorSchema(
    // Main
    val primary500: Color = Color(0xFF338FFF),
    val primary400: Color = Color(0xFF33B1FF),
    val primary300: Color = Color(0xFF3633FF),
    val primary200: Color = Color(0xFF4C33FF),
    val primary100: Color = Color(0xFF33B1FF),
    ...
    // Alert & Status
    val success: Color = Color(0xFF3633FF),
    ...
    val buttonDisabled: Color = Color(0xFF33DBFF),
    ...
    // Gradients
    val gradientGreen: List<Color> = listOf(Color(0xFF246BFD), Color(0xFF3633FF)),
...
val bookingColorSchema = BookingColorSchema()
val LocalBookingColorSchema = staticCompositionLocalOf { bookingColorSchema }

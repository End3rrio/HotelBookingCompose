...
import com.mikhienkov.designsystem.theme.LoginSocialButtonRippleTheme
...
private object LoginSocialButtonDefaults {
    ...
    @Composable
    fun containerColor() =
        if (BookingTheme.theme.isDark) BookingTheme.colors.dark2 else BookingTheme.colors.white

    @Composable
    fun border() = BorderStroke(
        width = 1.dp,
        color = if (BookingTheme.theme.isDark) BookingTheme.colors.dark3 else BookingTheme.colors.greyscale200
    )
}
